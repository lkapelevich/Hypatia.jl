...
insts["various"] = [
    ((25, 45, 75, 10, true, false, false), :SOCPSDLog),
    ...
    ((25, 45, 75, 10, false, false, true), :SOCPSDLog),
    ((25, 45, 75, 10, false, false, true), :ExpPSD),
    ((25, 45, 75, 10, false, false, true), :SOCExpPSD),
    ((50, 90, 150, 10, true, false, false), :SOCPSDLog),
    ...
    ((50, 90, 150, 10, false, false, true), :SOCPSDLog),
    ((100, 180, 300, 10, true, false, false), :SOCPSDLog),
